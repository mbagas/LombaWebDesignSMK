  ...
  <div class="contains">
    ...
    <div class="row">
      ...
      <div class="indicator">
        ...
        <a class="active" href="#">Smart-Refrigerator</a>
      </div>
      ...
      <div class="col col-7 arts">
        ...
        <div class="article">
          ...
          <div class="description">
            ...
            <p>
              Smart-Refrigerator adalah kulkas pintar yang dapat membantu anda mengontrol keaadan kulkas anda.
              Seperti menyesuaikan dingin sesuai kebutuhan ini derajat terhadap benda yang ada didalamnya.
            </p>
