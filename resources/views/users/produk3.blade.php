  ...
  <div class="contains">
    ...
    <div class="row">
      ...
      <div class="indicator">
        ...
        <a class="active" href="#">Smart Farm</a>
      </div>
      ...
      <div class="col col-7 arts">
        ...
        <div class="article">
          ...
          <div class="description">
            ...
            <p>
              E-Farm adalah pertanian yang menggunakan teknologi Internet of Things. Tujuan pembangunan E-Farm adalah
              untuk memudahkan petani dalam bertani. teknologi ini bisa melihat kondisi tanaman. E-Farm juga dapat menyiram secara otomatis jika
              sensor yang mendeteksi tanaman melihat bahwa tanaman kekurangan air.
            </p>
