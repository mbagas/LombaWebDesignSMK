  ...
  <div class="contains">
    ...
    <div class="row">
      ...
      <div class="indicator">
        ...
        <a class="active" href="#">IoT Camp</a>
      </div>
      ...
      <div class="col col-7 arts">
        ...
        <div class="article">
          ...
          <div class="description">
            ...
            <p>
              IoT Camp adalah tempat untuk pelatihan dalam belajar Internet of Things. Tujuan pembentukan pelatihan ini adalah untuk mengembangkan
              penggunaan IoT dalam Nusantara. Dimana penggunaan IoT masih kurang didalam Nusantara.
            </p>
