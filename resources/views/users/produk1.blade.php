      ...
      <div class="col col-7 arts">
        ...
        <div class="article">
          ...
          <div class="description">
            <img src="{{asset('/image/product1.1.jpg')}}" alt="">
            <p>
              E-Door atau Electronic Door adalah pintu yang bisa anda manipulasi dari jauh. Yang dapat dimanipulasi
              dari pintu ini adalah anda bisa melihat apakan pintu ini sudah terkunci atau belum dan anda bisa menguncinya dari jauh
              jika belum terkunci.
            </p>
