...
<html lang="en" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".navbar">
    <div class="nav" id="nav">
      ...
      <div class="link">
        <a class="nav-link" onclick="document.getElementById('login').style.display='block'" style="width:auto;" >Login</a>
      </div>
      <div class="link">
        <a onclick="document.getElementById('signup').style.display='block'" class="nav-link" >Sign In</a>
      </div>
      <div class="link">
        <a class="nav-link active" onclick="smoothScroll(document.getElementById('product'))">Product</a>
      </div>
      <div class="link">
        <a class="nav-link" onclick="smoothScroll(document.getElementById('blog'))">Blog</a>
      </div>
      <div class="link">
        <a href="/home/about" class="nav-link" >About</a>
      </div>

        <a href="javascript:void(0);" class="icon" onclick="collapse()" id="close"><i class="fa fa-bars fa-5"></i></a>
      </div>
    </div>
            ...
            <div class="col col-3">
              <div class="footer-widget">
                ...
                <p class="content-foot text">
                  ...
                  Nusantara generasi ke-4. Kami fokus mengembangkan produk-produk yang dapat
                  digunakan dalam industri 4.0. Kami juga membantu startup baru yang bergerak dalam
